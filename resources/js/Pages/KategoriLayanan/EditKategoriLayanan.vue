<template>
  <LayoutUtama
    judul-halaman="Edit Kategori Layanan"
    deskripsi-halaman="Ubah informasi kategori layanan"
  >
    <div class="max-w-2xl">
...
const props = defineProps({
  kategoriLayanan: Object,
  errors: Object
})

const form = useForm({
  nama_kategori: props.kategoriLayanan.nama_kategori,
  deskripsi: props.kategoriLayanan.deskripsi,
  harga_per_kg: props.kategoriLayanan.harga_per_kg,
  estimasi_hari: props.kategoriLayanan.estimasi_hari
})

const submitForm = () => {
  form.put(route('kategori-layanan.update', props.kategoriLayanan.id))
}
</script>
